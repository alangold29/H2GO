...
export default function TrustStrip() {
  ...
  const features = [
    { icon: <ShieldCheck className="w-6 h-6" />, title: t('Safe Environment', 'Entorno Seguro') },
    { icon: <UserCheck className="w-6 h-6" />, title: t('Expert Instructors', 'Instructores Expertos') },
    { icon: <Users className="w-6 h-6" />, title: t('Small Groups', 'Grupos Pequeños') },
    { icon: <Thermometer className="w-6 h-6" />, title: t('Heated Clean Pool', 'Piscina Temperada') },
    { icon: <Waves className="w-6 h-6" />, title: t('All Ages Welcome', 'Todas las Edades') },
  ];
